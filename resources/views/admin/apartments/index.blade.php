			...
			<tbody>
				@foreach ($apartments as $apartment)
					<tr>
							...
							@if ($apartment->is_sponsored)
								<div class="d-flex justify-content-center text-nowrap">
									<div class="ms-badge green">
										{{ \Carbon\Carbon::parse($apartment->sponsorships->first()->pivot->end_date)->setTimezone('Europe/Rome')->format('d-m-Y - H:i') }}
									</div>
								</div>
							@endif
						</td>
						...
						<td class="col text-center align-middle">
							<div
								class="row g-2 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-7
                        justify-content-end justify-content-md-between justify-content-xl-around align-items-center">
								<!--    SHOW    -->
								<div class="col d-flex justify-content-center align-items-center">
									<a class="ms-action-button blue" href="{{ route('admin.apartments.show', ['apartment' => $apartment]) }}">
								...
								<!--    EDIT    -->
								<div class="col d-flex justify-content-center align-items-center">
									<a class="ms-action-button blue" href="{{ route('admin.apartments.edit', ['apartment' => $apartment]) }}">
								...
								<!--    MESSAGES    -->
								<div class="col d-flex justify-content-center align-items-center">
									<a class="ms-action-button blue" href="{{ route('admin.apartments.chat', ['id' => $apartment->id]) }}">
								...
								<!--    STATISTICS    -->
								<div class="col d-flex justify-content-center align-items-center">
									<a class="ms-action-button blue" href="{{ route('admin.apartments.statistics', ['id' => $apartment->id]) }}">
								...
								<!--    DELETE    -->
								<div class="col d-flex justify-content-center align-items-center">
									<div type="button" class="ms-action-button danger" data-bs-toggle="modal"
