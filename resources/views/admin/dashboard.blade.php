    ...
    <div class="w-75 m-auto text-center d-flex flex-column align-items-center">
        ...
        <div class="w-50 d-flex justify-content-evenly">
            <a href="{{ route('admin.apartments.create') }}" class="btn px-4 py-3 fw-bold"
               style="background-color: #485ba1; color: white"><i class="bi bi-file-earmark-plus"></i> Add New Apartment
            </a>
            <a href="{{ route('admin.apartments.index') }}" class="btn px-4 py-3 fw-bold"
               style="background-color: #9153a9; color: white"><i class="bi bi-file-earmark-plus"></i> View Your
                Apartments</a>
        </div>
    </div>
@endsection
